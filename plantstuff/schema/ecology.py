...
class WetlandEcology(Model):
    ...
    native_wetland_indicator = ListType(StringType(choices=WETLAND_STATUSES))
    us_wetland_region = ListType(StringType(choices=[
        "region 1 (northeast)",
        "region 2 (southeast)",
...
class Ecology(Model):
    ...
    native_status_code = StringType(choices=[
    ...
    locales = ListType(StringType(choices=US_COUNTIES))
    # TODO: add
    # "nreg_wet_status =
